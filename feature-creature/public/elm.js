...
var _gust$feature_creature$App_AppConfig$AppConfig = F2(
	function (a, b) {
		return {productsApiPath: a, user: b};
	});

var _gust$feature_creature$App_Products_Product$init = F2(
	function (prodID, prodName) {
		return {id: prodID, name: prodName};
	});
var _gust$feature_creature$App_Products_Product$Product = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _gust$feature_creature$App_Products_Product$FetchProductsFailed = function (a) {
	return {ctor: 'FetchProductsFailed', _0: a};
};
var _gust$feature_creature$App_Products_Product$FetchProductsSucceeded = function (a) {
	return {ctor: 'FetchProductsSucceeded', _0: a};
};

var _gust$feature_creature$App_Products_Requests$productsUrl = function (appConfig) {
	return A2(_elm_lang$core$Basics_ops['++'], appConfig.productsApiPath, '/api/products');
};
...
var _gust$feature_creature$App_Products_Requests$getProducts = function (appConfig) {
	return A3(
		...
		_gust$feature_creature$App_Products_Product$FetchProductsFailed,
		_gust$feature_creature$App_Products_Product$FetchProductsSucceeded,
		A2(
			_evancz$elm_http$Http$get,
			_gust$feature_creature$App_Products_Requests$parseProducts,
			_gust$feature_creature$App_Products_Requests$productsUrl(appConfig)));
};

var _gust$feature_creature$Data_External$LoadedWithError = function (a) {
	return {ctor: 'LoadedWithError', _0: a};
};
var _gust$feature_creature$Data_External$Loaded = function (a) {
...
var _gust$feature_creature$UI_Layout$withLayout = function (content) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('main_content'),
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Hi there ', app.appConfig.user))
					]))
			]));
};
...
var _gust$feature_creature$App_App$App = F2(
	function (a, b) {
		return {appConfig: a, products: b};
	});
var _gust$feature_creature$App_App$ProductMsg = function (a) {
	return {ctor: 'ProductMsg', _0: a};
};
var _gust$feature_creature$App_App$init = function (appConfig) {
	var initialState = {appConfig: appConfig, products: _gust$feature_creature$Data_External$NotLoaded};
	return {
		ctor: '_Tuple2',
		_0: initialState,
		_1: A2(
			_elm_lang$core$Platform_Cmd$map,
			_gust$feature_creature$App_App$ProductMsg,
			_gust$feature_creature$App_Products_Requests$getProducts(appConfig))
	};
};

var _gust$feature_creature$Main$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _gust$feature_creature$App_App$init,
			update: _gust$feature_creature$App_App$update,
			view: _gust$feature_creature$App_App$view,
	...
	flags: A2(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'productsApiPath', _elm_lang$core$Json_Decode$string),
		function (productsApiPath) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'user', _elm_lang$core$Json_Decode$string),
				function (user) {
					return _elm_lang$core$Json_Decode$succeed(
						{productsApiPath: productsApiPath, user: user});
				});
		})
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _gust$feature_creature$Main$main === 'undefined' ? null : _gust$feature_creature$Main$main);
